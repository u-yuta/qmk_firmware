...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_DEFAULT] = LAYOUT_ortho_5x12(
        ...
        KC_BSPC,    KC_NO,      KC_LGUI,    KC_LALT,    KC_LCTL,    SFT_T(KC_SPC),MO(_SYM),   JP_MHEN,    JP_HENK,    KC_RALT,    KC_NO,     KC_ENT
    ),
	[_SYM] = LAYOUT_ortho_5x12(
        ...
        KC_TRNS,    JP_PIPE,    JP_EQL,     JP_LCBR,    JP_RCBR,    JP_TILD,    JP_AMPR,    JP_ASTR,    KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS,
