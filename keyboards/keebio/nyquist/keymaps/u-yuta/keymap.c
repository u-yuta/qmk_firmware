...
combo_t key_combos[] = {
  ...
  [ZSLSH_CWTOGG] = COMBO(zslsh_combo, CW_TOGG),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_DEFAULT] = LAYOUT_ortho_5x12(
        ...
        SFT_T(KC_Z),  KC_X,    KC_C,    KC_V,    KC_B,             SC_LSPO,   KC_LSFT,     KC_N,       KC_M,     KC_COMM, KC_DOT, RSFT_T(KC_SLSH),
        KC_NO,        KC_LGUI, KC_LALT, KC_LCTL, LT(_SYM, KC_SPC), KC_BSPC,   KC_ENT,      MO(_NUM),   MO(_FUN), KC_NO,   KC_NO,  KC_RALT
    ),
	[_SYM] = LAYOUT_ortho_5x12(
        KC_NO,          KC_NO,       KC_NO,       KC_NO,       KC_NO,      KC_NO,     KC_NO,     KC_F6,     KC_NO,     KC_NO,     KC_NO,     KC_NO,
        ...
        SFT_T(JP_PIPE), JP_AT,       JP_LCBR,     JP_RCBR,     JP_TILD,    KC_NO,     KC_NO,     JP_EQL,    JP_MINS,   KC_TRNS,   KC_TRNS,   KC_TRNS,
        KC_TRNS,        KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,    KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS
	),
	[_NUM] = LAYOUT_ortho_5x12(
        KC_F1,       KC_F2,       KC_F3,       KC_F4,       KC_F5,      KC_TRNS,   KC_F11,    KC_F6,     KC_F7,     KC_F8,     KC_F9,     KC_F10,
        JP_EXLM,     KC_7,        KC_8,        KC_9,        JP_PERC,    KC_NO,     KC_NO,     JP_AMPR,   JP_UNDS,   JP_LPRN,   JP_RPRN,   JP_YEN,
        JP_QUOT,     KC_4,        KC_5,        KC_6,        JP_ASTR,    KC_NO,     KC_NO,     KC_LEFT,   KC_DOWN,   KC_UP,     KC_RGHT,   JP_COLN,
        SFT_T(KC_0), KC_1,        KC_2,        KC_3,        JP_GRV,     KC_NO,     KC_NO,     JP_EQL,    JP_MINS,   KC_TRNS,   KC_TRNS,   KC_TRNS,
        KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,    KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS
	),
	[_FUN] = LAYOUT_ortho_5x12(
        KC_NO,      KC_F10,     KC_F11,     KC_F12,     KC_NO,       KC_NO,     KC_F11,    KC_F6,     KC_F7,     KC_F8,     KC_F9,     KC_F10,
        KC_NO,      KC_F7,      KC_F8,      KC_F9,      KC_F10,      KC_NO,     KC_NO,     KC_WH_L,   KC_WH_D,   KC_WH_U,   KC_WH_R,   KC_NO,
        KC_NO,      KC_F4,      KC_F5,      KC_F6,      KC_F11,      KC_NO,     KC_NO,     KC_MS_L,   KC_MS_D,   KC_MS_U,   KC_MS_R,   KC_NO,
        KC_0,       KC_F1,      KC_F2,      KC_F3,      KC_NO,       KC_NO,     KC_NO,     KC_NO,     KC_BTN1,  KC_BTN3,  KC_BTN2,  KC_TRNS,
        KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,     KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS
	)
};
